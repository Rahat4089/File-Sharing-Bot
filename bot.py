    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/still_alivenow For Support")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/still_alivenow For Support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated By \nhttps://t.me/still_alivenow")
        self.LOGGER(__name__).info(f"""ミ💖 GENZ 💖彡""")
