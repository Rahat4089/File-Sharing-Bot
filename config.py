...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8197383455:AAGF7d3iQJ01wg1FViKDG17om_ws0qXldxU")
API_ID = int(os.environ.get("API_ID", "23933044"))
API_HASH = os.environ.get("API_HASH", "6df11147cbec7d62a323f0f498c8c03a")


OWNER_ID = int(os.environ.get("OWNER_ID", "7125341830"))
DB_URL = os.environ.get("DB_URL", "mongodb+srv://animepahe:animepahe@animepahe.o8zgy.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[7125341830]
    for x in (os.environ.get("ADMINS", "7125341830").split()):
        ADMINS.append(int(x))
except ValueError:
